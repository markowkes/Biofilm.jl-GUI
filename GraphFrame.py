...
class GraphFrame(customtkinter.CTkFrame):
    ...
    def getParams(self):
        ...
        if self.type == 'constant':
            ...
            list.append(str(self.con_y))
        elif self.type == 'periodic':
            list.append('periodic')
            list.append(str(self.per_amplitude))
            list.append(str(self.per_period))
            list.append(str(self.per_duration))
            list.append(str(self.per_tstart))
        elif self.type == 'sin':
            list.append('sin')
            list.append(str(self.sin_amplitude))
            list.append(str(self.sin_period))
            list.append(str(self.sin_y_offset))
        return list
