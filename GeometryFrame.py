...
class GeometryFrame(customtkinter.CTkFrame):
    ...
    def initGeometryFrame(self):
        ...
        #Volume:
        volume_label = customtkinter.CTkLabel(self, text = "Volume (m³)").grid(row = 1, column = 0)
        volume_entry = customtkinter.CTkEntry(self, textvariable=self.params["volume"])
        volume_entry.grid(row = 1, column = 1, pady = 3)

        #Surface Area:
        surface_area_label = customtkinter.CTkLabel(self, text = "Surface area of biofilm (m²)").grid(row = 2, column = 0)
        ...
        #Flowrate:
        flowrate_label = customtkinter.CTkLabel(self, text = "Flowrate through tank (m³/d)").grid(row = 3, column = 0, padx = 8)
        ...
        initial_thickness_label = customtkinter.CTkLabel(self, text = "Biofolm inital thickness (m)").grid(row = 7, column = 0)
        ...
        boundary_thickness_label = customtkinter.CTkLabel(self, text = "Boundary layer thickness (m)").grid(row = 8, column = 0)
        ...
        kdet_label = customtkinter.CTkLabel(self, text = "kdet (m⁻¹d⁻¹)").grid(row = 9, column = 0)
        kdet_entry = customtkinter.CTkEntry(self, textvariable=self.params["kdet"])
        kdet_entry.grid(row = 9, column = 1, pady = 3)
