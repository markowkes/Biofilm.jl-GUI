...
class FileLoader():
    ...
    def saveDataToStructures(self, params, solutes_scrollable_object_frame, particulates_scrollable_object_frame):
        ...
        for solute_index in range(col_count):
            ...
            new_frame = SoluteObjectFrame.ObjectFrame(solutes_scrollable_object_frame, frame_params) #Problem! the 'None' here is the master, which should really be the scrollable object frame
        ...
        for particulate_index in range(row_count):
            ...
            new_frame = ParticulateObjectFrame.ObjectFrame(particulates_scrollable_object_frame, frame_params) #Problem! the 'None' here is the master, which should really be the scrollable object frame
