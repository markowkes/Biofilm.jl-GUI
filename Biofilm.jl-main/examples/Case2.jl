...
p = (
    ...
    Sbo =  [0.0, 0.0],      # Biofilm substrates concentration initial condition(s)   #by default, this can take Sto 
    Yxs =  [Yxs -Yxs/Yps],  # Biomass yield coefficient on substrate    reaction menu
    ...
    srcS = [(S,X,Lf,t,z,p) -> 0.0,  
            (S,X,Lf,t,z,p) -> 0.0 ],  #reaction menu
